...
<html lang="<?=$lang?>"
  ...
  <head>
    ...
    <style id="theme-variables">
      ...
      $linkMutedColor = $linkColor->scale('okc', .5)->replace('a', .6);
    ...
    <section id="demo">
      ...
      <div id="saisie" class="subsection">
        ...
        <div class="exemples-saisie exemples-fonctions">
          ...
          <button type="button" class="exemple"><kbd>orchid.interpolateInSteps(palegreen, 4, { interpolationSpace: oklch })</kbd></button>
